...
public class UserOderInfoLabel {
    ...
    public static void main(String[] args) {
        ...
        SingleOutputStreamOperator<JSONObject> mapOrderInfoAndDetailModelDs = processSkuInfoJoinBaseTrademark
                .map(new MapCategoryAndTrademarkAndPriceAndTimeFunc(dim_base_categories, category_rate_weight_coefficient, trademark_rate_weight_coefficient,price_rate_weight_coefficient,time_rate_weight_coefficient));
